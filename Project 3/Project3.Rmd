...
paste("R:",round(nrow(r_listings_df)/nrow(results),digits=2))
paste("Python:",round(nrow(python_listings_df)/nrow(results),digits=2))
paste("Java:",round(nrow(java_listings_df)/nrow(results),digits=2))
paste("SQL:",round(nrow(SQL_listings_df)/nrow(results),digits=2))
paste("Scala:",round(nrow(scala_listings_df)/nrow(results),digits=2))
```
...
paste("Tableau:",round(nrow(tableau_listings_df)/nrow(results),digits=2))
paste("Spark:",round(nrow(spark_listings_df)/nrow(results),digits=2))
paste("Hadoop:",round(nrow(hadoop_listings_df)/nrow(results),digits=2))
paste("SAS:",round(nrow(scala_listings_df)/nrow(results),digits=2))
```
