...
We see states with the highest amount of data science jobs are New York, California, and the District of Columbia. This is expected, but it is also interesting to see that North Carolina, Ohio, and Vermont are have high frequencies of data science jobs.

Looking at data science jobs by city, it is evident that New York/Manhattan are a hub for data scientists. However, Rensselaer also ranks highly in terms of quantity data science Jobs. Surprisingly, San Francisco is low on the list of data science job availability. 
